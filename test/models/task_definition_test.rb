...
class TaskDefinitionTest < ActiveSupport::TestCase
  ...
  def test_export_task_definitions_csv
    ...
    task_defs_csv.each do |task_def_csv|
      ...
      keys_to_ignore = ['tutorial_stream', 'plagiarism_checks', 'start_week', 'start_day', 'target_week', 'target_day', 'due_week', 'due_day', 'scorm_enabled', 'scorm_time_delay_enabled', 'scorm_attempt_limit']
